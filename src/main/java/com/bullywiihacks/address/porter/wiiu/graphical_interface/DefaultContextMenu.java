...
public class DefaultContextMenu extends JPopupMenu
{
	...
	private void processClick(MouseEvent event)
	{
		...
		boolean enableUndo = undoManager.canUndo() && textComponent.isEditable();
		boolean enableRedo = undoManager.canRedo() && textComponent.isEditable();
		...
		{
			enablePaste = textComponent.isEditable();
		}
